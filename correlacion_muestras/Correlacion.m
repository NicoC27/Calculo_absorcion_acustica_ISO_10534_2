...
if t == 1 % 1) ISO - META
    ...
    xlabel('Desfase', 'FontSize', 16, 'FontName', 'Times New Roman');
    ylabel('Correlación Cruzada', 'FontSize', 16, 'FontName', 'Times New Roman');
    title('Correlación Cruzada (ISO - Metamateriales)', 'FontSize', 18, 'FontName', 'Times New Roman');
...
if t == 2 % 2) DOC - META
    ...
    xlabel('Desfase', 'FontSize', 16, 'FontName', 'Times New Roman');
    ylabel('Correlación Cruzada', 'FontSize', 16, 'FontName', 'Times New Roman');
    title('Correlación Cruzada (DOC - Metamateriales)', 'FontSize', 18, 'FontName', 'Times New Roman');
    legend("PLA - PETG","PLA - ABS", 'FontSize', 16, 'FontName', 'Times New Roman');
    grid on;
    ax = gca;
    ax.XAxis.FontSize = 12;
...
if t == 3 % 3) DOC - 50Hz
    ...
    xlabel('Desfase', 'FontSize', 16, 'FontName', 'Times New Roman');
    ylabel('Correlación Cruzada', 'FontSize', 16, 'FontName', 'Times New Roman');
    title('Correlación Cruzada (DOC - Metamateriales en 50 Hz)', 'FontSize', 18, 'FontName', 'Times New Roman');
    legend("PLA - PETG","PLA - ABS", 'FontSize', 16, 'FontName', 'Times New Roman');
    grid on;
    ax = gca;
    ax.XAxis.FontSize = 12;
...
if t == 4 % 4) ISO - TODAS
    ...
    xlabel('Desfase', 'FontSize', 16, 'FontName', 'Times New Roman');
    ylabel('Correlación Cruzada', 'FontSize', 16, 'FontName', 'Times New Roman');
    title('Correlación Cruzada (ISO - Todas las muestras)', 'FontSize', 18, 'FontName', 'Times New Roman');
...
if t == 5 % 5) DOC - TODAS
    ...
    xlabel('Desfase', 'FontSize', 16, 'FontName', 'Times New Roman');
    ylabel('Correlación Cruzada', 'FontSize', 16, 'FontName', 'Times New Roman');
    title('Correlación Cruzada (DOC - Todas las muestras)', 'FontSize', 18, 'FontName', 'Times New Roman');
    legend("PLA - PETG","PLA - ABS","PLA - CONV","PLA - PHONO", 'FontSize', 16, 'FontName', 'Times New Roman');
    grid on;    
    ax = gca;
    ax.XAxis.FontSize = 12;
